...
export class GameBloc {
  ...
  async new_tournament(tournamentID, users, prize) {
    return await this.wallet.callMethod({ contractId: this.contractId, method: "new_tournament", args: { tournament_id_hash: tournamentID, users: users, prize: prize } })
  }
