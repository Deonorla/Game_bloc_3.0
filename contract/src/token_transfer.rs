...
impl GameBloc {
  ...
  pub fn pay(&mut self) -> U128 {
    ...
    let to_transfer: Balance = if payed_so_far == 0 {
      ...
      assert!(payable_amount > STORAGE_COST, "Attach at least {} yoctoNEAR", STORAGE_COST);
    ...
    log!("Thank you {} for donating {}! You donated a total of {}", payer.clone(), payable_amount, payed_so_far);
